...
class _ScrollSampleState extends State<ScrollSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'SingleChildScrollView Sample'),
      body: SingleChildScrollView(
        child: Column(
          children: ScrollSample.images
              .map((image) => SampleContainer(
                    child: TwicImg(
                        src: image['url'], focus: image['focus'], ratio: 2.35),
                  ))
              .toList(),
        ),
      ),
