...
void main() {
  ...
  group('computeUrl', () {
    ...
    test('should compute url with cover transformation', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/cover=400x300/output=webp');
    });
    test('should compute url with cover transformation and manage default step',
      ...
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/cover=450x450/output=webp');
    });
    test('should compute url with contain transformation', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/contain=400x300/output=webp');
    });
    test('should compute url with dpr 2', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/contain=800x600/output=webp');
    });
    test('should compute url with step = 100', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/contain=400x312/output=webp');
    });
    test('should compute url with step = 100 and dpr2', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/contain=800x624/output=webp');
    });
    test('should compute url with a refit auto as fit is set to contain', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/refit=500x500(15p)/output=webp');
    });
    test('should compute url with a refit auto as fit is set to contain', () {
      expect(
          computeUrl(UrlData(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/refit=auto(15p)/contain=500x500/output=webp');
    });
    ...
    test(
      ...
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/cover=500x500/output=webp');
    });
    test(
      ...
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/cover=312x500/output=webp');
    });
    test(
      ...
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/cover=500x312/output=webp');
    });
    test('should compute url a refit cover transformation', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/refit=800x500/output=webp');
    });
    test('should compute url a refit auto transformation', () {
      expect(
          ...
          'https://demo.twic.pics/cat.jpg?twic=v1/refit=auto/contain=800x500/output=webp');
    });
    ...
    test('should compute url with poster = true', () {
      expect(
          ...
          'https://demo.twic.pics/video/skater.mp4?twic=v1/cover=800x500/output=image/output=webp');
    });
    ...
    test('should compute url with poster = true with video slicing from, to',
      ...
      expect(
          ...
          'https://demo.twic.pics/video/skater.mp4?twic=v1/cover=800x500/from=2.1/output=image/output=webp');
    });
    ...
    test(
      ...
      expect(
          ...
          'https://demo.twic.pics/video/skater.mp4?twic=v1/cover=800x500/from=4/output=image/output=webp');
    });
    test(
  ...
  group('computeUrls', () {
    ...
    test('should compute urls with preview and poster', () {
      ...
      expect(
        urls.poster,
        'https://demo.twic.pics/video/skater.mp4?twic=v1/cover=400x300/from=4/output=image/output=webp',
      );
    });
