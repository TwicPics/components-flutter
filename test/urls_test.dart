...
void main() {
  group('isAbsolute', () {
    test('should return true', () {
      ...
      expect(
          isAbsolute(
              src: 'https://demo.twic.pics/myasset.jpg',
    ...
    test('should return false', () {
      ...
      expect(
          isAbsolute(
              src: 'image:myasset.jpg', domain: 'https://demo.twic.pics'),
          false);
    });
  });
  ...
  group('computeTransform', () {
    test('should return empty as there is no transform', () {
      expect(
          computeTransform(
            context:
                Context(mode: 'cover', size: Size(width: 200, height: 100)),
            transform: '',
          ),
          '');
    });
    ...
    test('should return a contain transformation', () {
      expect(
          computeTransform(
              context:
                  Context(mode: 'contain', size: Size(width: 200, height: 100)),
              transform: '/*'),
          '/contain=200x100');
    });
    test('should return a contain transformation without height', () {
      expect(
          computeTransform(
              context: Context(mode: 'contain', size: Size(width: 200)),
              transform: '/*'),
          '/contain=200x-');
    });
